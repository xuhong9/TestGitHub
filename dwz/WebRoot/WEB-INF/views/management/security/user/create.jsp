...
<form method="post" action="<%=basePath %>/management/security/user/create" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogAjaxDone);">
